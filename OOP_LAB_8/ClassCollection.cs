...
namespace OOP_LAB_8
{
    ...
    public void WriteFile()
    {
        ...
        string path = @"D:\Visual Studio 2019\OOP(C#)\OOP_LAB_8\collection.txt";
        if (!File.Exists(path))
        {
    ...
    public void ObjectFile()
    {
        Console.ForegroundColor = ConsoleColor.Yellow;
        DateTime dateTime = DateTime.Now;
        string path = @"D:\Visual Studio 2019\OOP(C#)\OOP_LAB_8\ObjectFile.txt";
        if (!File.Exists(path))
        {
            using (StreamWriter sw = new StreamWriter(path))
            {
    ...
    {
        string path = @"D:\Visual Studio 2019\OOP(C#)\OOP_LAB_8\Read.txt";
        if (File.Exists(path))
        {
    ...
    public void ReadJsonFile()
    {
            ...
            string path = @"D:\Visual Studio 2019\OOP(C#)\OOP_LAB_8\Read.json";
            if (File.Exists(path))
            {
